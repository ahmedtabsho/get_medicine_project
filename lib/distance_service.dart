...
Future<double> calculateDistance(
    List<double> firstCoordinates, List<double> secondCoordinates) async {
  ...
  const apiKey = "5b3ce3597851110001cf62481bf4aa67caa64a0a899873e99b2d2dc0";
  final url =
      "https://api.openrouteservice.org/v2/directions/driving-car?api_key=$apiKey&start=$firstLongitude,$firstLatitude&end=$secondLongitude,$secondLatitude";
